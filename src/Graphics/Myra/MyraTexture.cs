...
/// Each instance gets a unique <see cref="Id"/> for batch grouping in <see cref="MyraRenderer.DrawQuad"/>.
/// </summary>
public readonly struct MyraTexture(Texture texture, TextureView view, Dictionary<TextureFiltering, ResourceSet> resourceSets)
{
	private static uint _nextId;

	/// <summary>Unique identifier used for batch grouping in <see cref="MyraRenderer.DrawQuad"/>.</summary>
